...
4. **Verify your fix.** Re-run only the specific tests that failed — not the full test suite. Use targeted test commands (e.g. pass the failing test file or test name) to confirm your fix works before pushing.
